...
public static class DependencyInjection
{
    ...
    {
        var connectionString = builder.Configuration.GetConnectionString("CleanlinessTrimmedDb");
        Guard.Against.Null(connectionString, message: "Connection string 'CleanlinessTrimmedDb' not found.");
