using CleanlinessTrimmed.Application.Common.Models;
using CleanlinessTrimmed.Application.TodoItems.Commands.CreateTodoItem;
using CleanlinessTrimmed.Application.TodoItems.Commands.DeleteTodoItem;
using CleanlinessTrimmed.Application.TodoItems.Commands.UpdateTodoItem;
using CleanlinessTrimmed.Application.TodoItems.Commands.UpdateTodoItemDetail;
using CleanlinessTrimmed.Application.TodoItems.Queries.GetTodoItemsWithPagination;
